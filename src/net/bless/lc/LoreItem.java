    ...
    static List<LoreItem> loadConfig(Material mat, String folder) {
        ...
        for (String key: config.getKeys(false)) {
            ...
            if (weight instanceof String) {
                ...
                LoreCraft.log.highest("Weight is a different type!");
                item.weight = 0.0;
            }
            
            itemList.add(item);
            
            LoreCraft.log.highest("loaded item: "+item.name + item.lore.toString() + item.weight);
        }
